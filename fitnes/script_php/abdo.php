...
<head>
    ...
    <link rel="stylesheet" href="style/style_stat-kirch.css">
...
<body>
    <?php
        include "query_php\query_kirch.php";
        include "query_php\query_date_lenght.php";
        // <!-- popup*********** -->
        include "query_php\add_popup\add.php";
        $data = array(
            select_kirch()["kirch"], // Line bras data points
            select_kirch()["ass"], // Line fits data points
        );
    ...
    <div class="aktef_page">
        ...
        <div class="aktef_imge">
            <div class="card_img" id="img_aktef">
                ...
                <div class="detels_kirch_img" id="detels_kirch_img">
                    <div class="button_add_fit">
                        <p class="button_bras" id="button_kirch">add</p>
                        <?php
                            $tab = select_kirch()["kirch"];
                            echo "<p>".$tab[count($tab)-1]." cm</p>";
                        ?>
                    </div>
                    <div class="button_add_fit">
                        <p class="button_bras" id="button_ass">add</p>
                        <?php
                            $tab = select_kirch()["ass"];
                            echo "<p>".$tab[count($tab)-1]." cm</p>";
                        ?>
                    </div>
                </div>
