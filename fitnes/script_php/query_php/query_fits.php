<?php
if(isset($_GET['button_left_feet'])){
    $bras="left_fit";
    $task_name=$_GET["button_left_feet"];
    insert_feet($bras,$task_name);
    header('location: ..\feet.php');
}
if(isset($_GET['button_rigth_feet'])){
    $bras="rigth_fit";
    $task_name=$_GET["button_rigth_feet"];
    insert_feet($bras,$task_name);
    header('location: ..\feet.php');
}
function insert_feet($side,$val){
    include 'connection.php';
    /**rigth default */
    $tab=select_left_rigth_feet()["right_date"];
    /**if left */
    if($side=="left_fit")
    $tab=select_left_rigth_feet()["left_date"];
    ...
    function select_fits(){
        include 'connection.php';
        // Select data from table
        $sql = "SELECT sum(value) 
                FROM `body` 
                WHERE `type`='rigth_fit' or `type`='left_fit' 
                GROUP BY date";
    ...
    function select_left_rigth_feet(){
        include 'connection.php';
        // Select data from table
