...
<head>
    ...
    <link rel="stylesheet" href="style/style_stat-bras.css">
    <style>
        <?php
...
<body>
    <?php
        include "query_php\query_bras.php";
        include "query_php\query_date_lenght.php";
        // <!-- popup*********** -->
        include "query_php\add_popup\add.php";
        $data = array(
            select_left_rigth()["left"], // Line bras data points
            select_left_rigth()["right"], // Line fits data points
        );
    ...
    <div class="bras_page">
        ...
        <div class="bras_imge">
            <div class="card_img" id="img_left_bras">
                <img src="icons/bras.png" alt="">
                <div class="detels_bras_img" id="detels_bras_img_left">
                    <p class="button_bras" id="button_left_bras">add</p>
                    <?php
                        $tab = select_left_rigth()["left"];
                        echo "<p>".$tab[count($tab)-1]." cm</p>";
                    ?>
                </div>
            </div>
            <div class="card_img" id="img_rigth_bras">
                <img src="icons/bras2.png" alt="">
                <div class="detels_bras_img">
                    <p class="button_bras" id="button_rigth_bras">add</p>
                    <?php
                        $tab = select_left_rigth()["right"];
                        echo "<p>".$tab[count($tab)-1]." cm</p>";
                    ?>
                </div>
            </div>
